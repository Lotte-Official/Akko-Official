  ...
  async run(client, message, args) {
    ...
    return message.channel.send(
      new Discord.MessageEmbed()
        ...
        .setTitle("")
        .setDescription(
          `Akko [Support Server](${client.unicron.serverInviteURL}) `
        )
        .addField(
        ...
        .addField(
          `<a:arrow:783049866565779527> Ticket System`,
          `\`!Help Ticket, Make ticket commands for your server, Only Admin can use these commands.\``,
          true
        )
        .addField(
          `<a:arrow:783049866565779527> Dynamic Commands`,
          `\`!help Dynamic, Only Members with Manage Server Permissions can use these Commands.\``,
          true
        )
        .addField(
        ...
        .addField(
          `<a:arrow:783049866565779527> Search Commands`,
          `\`!help Search, Search commands\``,
          true
        )
        .addField(
          `<a:arrow:783049866565779527> Misc Commands`,
          `\`!help Misc, Get more infos about the bot,your server or user.\``,
          true
        )
        .addField(
          "<a:arrow:783049866565779527> Fun Commands",
          `\`!help Fun, Some fun commands for you and your friends\``,
          true
        )
